...
def main(args):
    ...
    model_cls = transformer_cache.Transformer
    ...
    features = dataset.get_training_input_src_context_eager(params.input, params)
    for x in features:
        print(x['source'])
    ...
    #
    #     features = dataset.get_training_input_eager(params.input, params)
    #
